...
$databaseConfig['database_host'] = 'localhost';
$databaseConfig['database_name'] = 'yyx';
$databaseConfig['database_user'] = 'root';
$databaseConfig['database_password'] = 'root';
$databaseConfig['database_charset'] = 'utf8';
$databaseConfig['database_prefix'] = 'yyx_';//数据库表前缀

//网站自己的配置
$siteConfig = array(
	'site_url'=>'http://yyx.796dice.com:8080',
	'site_name'=>'预言星',
);
