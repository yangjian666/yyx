...
function hideMenu(layer) {
	...
	if(jsmenu['active'][layer]) {
		try {
//		    $get(jsmenu['active'][layer].ctrlkey + '_menu').innerHTML = '';
//		    $('#'+jsmenu['active'][layer].ctrlkey + '_menu').remove();
		    $('#append_parent').empty();
		    //$get(jsmenu['active'][layer].ctrlkey).className = ctrlobjclassName;
		} catch(e) {}
