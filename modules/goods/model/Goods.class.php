...
class Goods extends DynamicModelTransformSupport{
    ...
    public function getLotteryCredit(){
        return $this->lotteryCredit;
    }
    public function setLotteryCredit($lotteryCredit){
        $this->lotteryCredit = $lotteryCredit;
    }
