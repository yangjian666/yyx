...
class User extends DynamicModelTransformSupport{
    ...
    public function getWealthTypeFuncName($type){
        $type = intval($type);
        $map = array('',
            'getAvailableMoney',
    ...
    public function getFreeTypeFuncName($type){
        $type = intval($type);
        $map = array('',
            'getFreezeMoney',
            'getFreezeIntegral',
     ...
     * @return double
     */
    public function getAvailableBtc(){
     ...
     *        	double
     */
    public function setAvailableBtc($availableBtc){
     ...
     *        	double
     */
    public function setFreezeBtc($freezeBtc){
     ...
     * @return double
     */
    public function getAvailableLtc(){
     ...
     *        	double
     */
    public function setAvailableLtc($availableLtc){
     ...
     * @return double
     */
    public function getFreezeLtc(){
        return $this->freezeLtc;
    }
     ...
     *        	double
     */
    public function setFreezeLtc($freezeLtc){
        $this->freezeLtc = $freezeLtc;
    }
     ...
     * @return double
     */
    public function getAvailableDoge(){
        return $this->availableDoge;
    }
     ...
     *        	double
     */
    public function setAvailableDoge($availableDoge){
        $this->availableDoge = $availableDoge;
    }
     ...
     * @return double
     */
    public function getFreezeDoge(){
        return $this->freezeDoge;
    }
     ...
     *        	double
     */
    public function setFreezeDoge($freezeDoge){
        $this->freezeDoge = $freezeDoge;
    }
