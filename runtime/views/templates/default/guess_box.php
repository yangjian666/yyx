...
<p class="r">
	...
	<!--
	<img src="http://www.yyx-test.com//res/images/f1.gif" /> &nbsp;&nbsp;
	<img src="http://www.yyx-test.com//res/images/f2.gif" />
	-->
...
<div class="rinfo">
	...
	<p class="tab">自定义</p>
	<?php }else{ ?>
	<p class="tab">投注<?php if($item['wealth_type'] == Guess::WEALTH_TYPE_MONEY){ ?>金币<?php }else{ ?>积分<?php } ?></p>
