...
<link rel="stylesheet" href="http://www.yyx-test.com//res/css/admin/manage.css" />
<link rel="stylesheet" href="http://www.yyx-test.com//res/css/admin/style.css" />
<script type="text/javascript" src="http://www.yyx-test.com//res/js/jquery/jquery-1.5.1.min.js"></script>
...
<script type="text/javascript" src="http://www.yyx-test.com//res/js/admin/dataList.js"></script>
<script type="text/javascript" src="http://www.yyx-test.com//res/js/tab.js"></script>
...
<div class="KK_ManageNav">
    ...
    <div class="KK_ManageSear right">
            ...
            <span class="s1">
                <a href="/admin/index/"><img src="http://www.yyx-test.com//res/images/admin/btn1.gif" style="padding-right:0px;" /></a>
                &nbsp;&nbsp;
            </span>
        </div>
    <?php } ?>
