...
<div class="wrapper960">
	<div class="KK_ManageIndex_mainbox">
    	<div class="KK_ManageIndex_mainbox_inner">
        	...
        	<!-- 
        	<img src="http://www.yyx-test.com//res/images/admin/logo.png" />
        	 -->
        	</div>
            <div class="KK_ManageIndex_nav">
            	<ul class="KK_ManageIndex_list">
                    <li id="o1" jqkey="0"><a href="/admin/guess/">
                    	<dl class="pic"><img src="http://www.yyx-test.com//res/images/admin/icon/li_bg6.png" /></dl>
                        <dl class="btn">竞猜管理</dl></a>
                    </li>
                    <li id="o2" jqkey="1"><a href="/admin/user/">
                    	<dl class="pic"><img src="http://www.yyx-test.com//res/images/admin/icon/li_bg2.png" /></dl>
                        <dl class="btn">用户管理</dl></a>
                    </li>
                    <li id="o3" jqkey="2"><a href="/admin/exchange/">
                    	<dl class="pic"><img src="http://www.yyx-test.com//res/images/admin/icon/li_bg4.png" /></dl>
                    ...
                    <li id="o4" jqkey="3"><a href="/admin/config/">
                    	<dl class="pic"><img src="http://www.yyx-test.com//res/images/admin/icon/li_bg.png" /></dl>
