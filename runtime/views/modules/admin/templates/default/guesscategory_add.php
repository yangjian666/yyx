    ...
    <div class="KK_ManageList_mainRt_side right">
        ...
        <div class="KK_ManageList_mainbox">
        	<div class="KK_ManageList_mainbox_inner">
            	<div class="KK_ManageList_position">当前位置 &gt;&gt; 竞猜管理 &gt;&gt; 添加竞猜分类</div>
                <h3>
                        ...
                        <div class="KK_content_list2_table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="cot"><input type="text" class="txt" name="m_name" /></td>
                                </tr>
                                <tr>
                                    <td class="name"><span class="must">*</span>竞猜点参数个数</td>
                                    <td class="cot"><input type="text" class="txt" name="m_parameter_count" value="1" /></td>
                                </tr>
                                <tr>
                                    <td class="name">启用状态</td>
                                    <td class="cot">
                                        <input class="rad" type="radio" name="m_status" value="1" checked />yes
                                        <input class="rad" type="radio" name="m_status" value="0" />no
                                    </td>
                                </tr>
                                 <tr>
                                    <td class="name">固定赔率状态</td>
                                    <td class="cot">
                                        <input class="rad" type="radio" name="m_fixed_odds" value="1" checked />yes
                                        <input class="rad" type="radio" name="m_fixed_odds" value="0" />no
                                    </td>
                                </tr>
                                 <tr>
                                    <td class="name">浮动赔率状态</td>
                                    <td class="cot">
                                        <input class="rad" type="radio" name="m_float_odds" value="1" checked />yes
                                        <input class="rad" type="radio" name="m_float_odds" value="0" />no
                                    </td>
                                </tr>
                                <tr>
                                    <td class="name">排序</td>
                                    <td class="cot"><input type="text" class="txt" name="m_sort_num" value="0" /></td>
                                </tr>
                            </table>
                            <table>
                                <colgroup>
