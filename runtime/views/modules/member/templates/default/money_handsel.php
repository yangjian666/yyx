<form style="margin:0px;" method="post" id="ajaxform" name="ajaxform" action="/member/money/handsel/?" enctype="multipart/form-data">
<h1>金币赠送</h1>
...
<div class="popupmenu_inner" style="padding:20px; width:300px;">
	...
	<div class="modal-body" style="padding:0px;">
			...
			<div class="control-group">
				<label for="msgcontent">赠送金币</label>
				<div class="controls">
					 <input type="text" class="span3" name="money" value="10">
				</div>
			</div>
