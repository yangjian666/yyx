...
<script type="text/javascript" src="http://www.yyx-test.com//res/js/validation/jquery.validate.min.js"></script>
<script type="text/javascript" src="http://www.yyx-test.com//res/js/validation/additional-methods.min.js"></script>
...
<div id="ajaxwaitid" style="display: none;">Loading...</div>	
	...
	<div class="container reg_header"><a href="<?php echo get_config('site_url')?>"><img src="http://www.yyx-test.com//res/images/logo.gif" /></a></div>
	...
	<div class="container reg_body">
		...
		<div class="applogin">
			...
			<div class="app">
				<a href="/member/login/app/?id=1"><img src="http://www.yyx-test.com//res/images/sina.gif" /></a> &nbsp;&nbsp;&nbsp;&nbsp;
				<a href="/member/login/app/?id=2"><img src="http://www.yyx-test.com//res/images/qq.gif" /></a>
			</div>
		</div>
...
var yqcode = <?php echo $_GET['yqcode']; ?> || 0;
if(yqcode > 0)
{
