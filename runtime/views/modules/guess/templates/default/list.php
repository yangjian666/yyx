				...
				<div class="filterlist">
					...
					<div class="fitem">
						...
						<ul>
                            ...
                            <li><a <?php if($params['wealth'] == '3'){ ?>class="sel"<?php } ?> href="<?php echo url("/guess/list/?history=$params[history]&cateid=$params[cateid]&custom=$params[custom]&wealth=3&odds=$params[odds]&time=$params[time]&keyword=$params[keyword]&range=$params[range]") ?>">莱特币</a></li>
                            <li><a <?php if($params['wealth'] == '4'){ ?>class="sel"<?php } ?> href="<?php echo url("/guess/list/?history=$params[history]&cateid=$params[cateid]&custom=$params[custom]&wealth=4&odds=$params[odds]&time=$params[time]&keyword=$params[keyword]&range=$params[range]") ?>">比特币</a></li>
                            <li><a <?php if($params['wealth'] == '5'){ ?>class="sel"<?php } ?> href="<?php echo url("/guess/list/?history=$params[history]&cateid=$params[cateid]&custom=$params[custom]&wealth=5&odds=$params[odds]&time=$params[time]&keyword=$params[keyword]&range=$params[range]") ?>">狗币</a></li>
                            ...
                            <li><a <?php if($params['wealth'] == '6'){ ?>class="sel"<?php } ?> href="<?php echo url("/guess/list/?history=$params[history]&cateid=$params[cateid]&custom=$params[custom]&wealth=3&odds=$params[odds]&time=$params[time]&keyword=$params[keyword]&range=$params[range]") ?>">吃喝玩乐</a></li>
						</ul>
					</div>
					<div class="fitem">
				...
				<div class="guess_list">
					...
					<div class="tab-content list_content">
						<div class="tab-pane active">
							<?php include_once('D:\phpStudy\yyx-master\runtime/views\./templates/default\guess_box.php');?>
							<?php echo $pages; ?>
				        </div>
					</div>
				</div>
