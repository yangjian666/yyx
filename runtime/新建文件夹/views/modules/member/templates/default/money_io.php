...
<script type="text/javascript" src="http://yyx.796dice.com:8080/res/js/uploadify/jquery.uploadify.v2.1.4.min.js"></script>
	<div class="setting_body">
		<div class="caption"><?php echo $user->getWealthTypeName($_GET['wealth_type']); ?>收支明细</div>
        <ul class="nav nav-tabs" id="setting_tab">
	        ...
	        <li><a href="/member/money/?wealth_type=<?php echo $_GET['wealth_type']?>">我的<?php echo $user->getWealthTypeName($_GET['wealth_type']); ?></a></li>
        </ul>
        ...
        <div class="tab-content setting_list">
			<div class="tab-pane active">
				...
				<thead>
					<tr>
						<th><?php echo $user->getWealthTypeName($_GET['wealth_type']); ?></th>
						<th>余额</th>
						<th>时间</th>
						<th>项目</th>
					</tr>
