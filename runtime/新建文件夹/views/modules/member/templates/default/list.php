<?php include_once('E:\yyx\runtime/views\./templates/default\header.php');?>
	...
	<div class="user_body">
        ...
        <ul class="nav nav-tabs" id="user_tab">
			<li <?php echo $astr[3]; ?>><a href="/member/list/t-3.shtml">金币排行</a></li>
			<li <?php echo $astr[2]; ?>><a href="/member/list/t-2.shtml">积分排行</a></li>
			<li <?php echo $astr[1]; ?>><a href="/member/list/t-1.shtml">胜率排行</a></li>
			<li><a href="/member/friend/">我的好友</a></li>
	        <li <?php echo $astr[0]; ?>><a href="/member/list/">全部用户</a></li>			
        </ul>
        ...
        <div class="tab-content user_list">
			...
			<div class="tab-pane active" id="t1">
				...
				<div class="useritem">
					...
					<div class="operbtn">
						<?php if(strpos(','.$user->getFriend().',',','.$item[id].',')!==false){ ?>
						<a href="/member/friend/cancel/?uid=<?php echo $item[id]; ?>" class="btn" onclick="ajaxmenu(event, this.id, 1, 2000, 'afterCancelFriend')" id="follow_cancel_<?php echo $item[id]; ?>" >解除好友</a>
						<?php }else{ ?>
						<a href="/member/friend/add/?uid=<?php echo $item[id]; ?>" class="btn btn-primary" onclick="ajaxmenu(event, this.id, 1, 2000)" id="follow_add_<?php echo $item[id]; ?>" >加好友</a>
						<?php } ?>
					</div>
				</div>
				<?php } ?>
