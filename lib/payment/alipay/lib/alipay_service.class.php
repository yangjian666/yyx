...
require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . "./alipay_submit.class.php");
require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . "./alipay_partner_submit.class.php");
class AlipayService {
    ...
    function create_partner_trade_by_buyer($para_temp) {
        ...
        $button_name = "确认";
        //生成表单提交HTML文本信息
        $alipaySubmit = new AlipayPartnerSubmit();
        $html_text = $alipaySubmit->buildForm($para_temp, $this->alipay_gateway_new, "get", $button_name,$this->aliapy_config);
