 ...
 */
require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . "./alipay_core.function.php");
class AlipayPartnerSubmit {
	/**
     * 生成要请求给支付宝的参数数组
	...
	function buildForm($para_temp, $gateway, $method, $button_name, $aliapy_config) {
		...
		$sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='".$gateway."_input_charset=".trim(strtolower($aliapy_config['input_charset']))."' method='".$method."' style='display:none;'>";
