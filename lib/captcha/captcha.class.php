 ...
 * EASYDER 验证码图片文件
 * ============================================================================
 * 版权所有 2008-2012 东莞易得网络科技有限公司，并保留所有权利。
 * 网站地址: http://www.easyder.com；
 * ----------------------------------------------------------------------------
 * 这不是一个自由软件！您只能在不用于商业目的的前提下对程序代码进行修改和
 * 使用；不允许对程序代码以任何形式任何目的的再发布。
 * ============================================================================
 * $Author: ffreedom $
 * $Id: captcha.php 2011-12-27 $
*/
class captcha
{
    /**
     ...
     * @return  bool
     */
    function captcha($folder = '', $width = 80, $height = 20)
    {
        if (!empty($folder))
        {
            $this->folder = $folder;
     ...
     * @return void
     */
    function __construct($folder = '', $width = 80, $height = 20)
    {
        session_start();
